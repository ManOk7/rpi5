...
# ✅ Correct capture pipeline for RPi 5
...
while True:
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            cv2.putText(frame, f"EAR: {ear:.2f}", (30, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)

            if ear < 0.20:
                cv2.putText(frame, "BLINK", (200, 100), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 0, 0), 3)

    cv2.imshow("Blink / EAR Detection - RPi 5", frame)
